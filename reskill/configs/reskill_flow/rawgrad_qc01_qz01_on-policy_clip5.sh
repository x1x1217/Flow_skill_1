...
condition_guidance_grad_clip=5.0

environment_name=slippery_push
swanlab_project=Flow_skill_1_${environment_name}
log_subdir=on-policy
run_name=condflow${use_condition_flow}_condgrad${condition_use_grad}_${dataset_name}_qz${guidance_scale}_qc${condition_guidance_scale}_cgwarm${condition_guidance_warmup_epoch}_on-policy_gradClip5.0_new
